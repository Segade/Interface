...
public class CentralViewBackup extends JFrame implements ActionListener, FocusListener, KeyListener  {
        ...
        keyListener = new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (id == KeyEvent.KEY_TYPED)
                    keyPressed = String.valueOf(e.getKeyChar());

                else{
                    int keyCode = e.getKeyCode();
                    keyPressed =  KeyEvent.getKeyText(keyCode);
